    ...
    return (
        <div className='p-10 max-w-3xl mx-auto'>
            <div className='flex justify-center mb-5'>
                <input onKeyDown={handleKeyDown} onChange={(e) => setSearchValue(e.target.value)} value={searchValue} className='w-350px border text-lg border-solid border-grey outline-none px-5 py-3 transition-searchbar duration-300 rounded-l-100px focus:rounded-l-lg' type="text" placeholder={`Search freelancers by ${searchType}`} />
